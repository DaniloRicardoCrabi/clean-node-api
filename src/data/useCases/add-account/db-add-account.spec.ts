...
const makeAddAcccountRepository = (): AddAccountRepository => {
...
const makeSut = (): SutTypes => {
  ...
  const addAccountRepositoryStub = makeAddAcccountRepository();
...
describe('DbAddAccount UseCases', () => {
  ...
  test('Should throw if addAccout throws', async () => {
    const { sut, addAccountRepositoryStub} = makeSut();
